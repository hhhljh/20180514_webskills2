...
<div id="con">
	...
	<div class="wrap store">
        ...
        <input type="hidden" name="action" value="out_pro">
        <div>   
            <span class="red">*</span> 거래처 : 
            <select>
                <option value="">거래처선택</option>  
                <option value=""><?php echo $client['name'] ?></option>  
            </select>
            &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <span class="red">*</span> 출고날짜 : <input type="text" name="date" id="in_date" style="width:150px; text-align:center;">
              &nbsp;&nbsp;&nbsp;&nbsp;
            <button>출고하기</button>
        </div>
        </form>
        ...
        <div class="s_list" >
        	...
        	<table class="list mat40">
                ...
                <tr>
                	<td><?php echo $out_pro['client'] ?></td>
                    <td><?php echo $out_pro['product'] ?></td>
                    <td><?php echo $out_pro[''] ?></td>
                    <td><?php echo $out_pro[''] ?></td>
                    <td><?php echo $out_pro['price'] ?></td>
                    <td><?php echo $out_pro[''] ?></td>
                    <td><?php echo ($out_pro['quantity']) ?></td>
                    <td><?php echo $out_pro['date'] ?></td>
                </tr> 
            </table>
